...
import argparse
import os
from xenomatix_utils.DataLoader import S3DISDataset
import torch
import datetime
import logging
...
def parse_args():
    ...
    parser.add_argument('--npoint', type=int, default=12280, help='Point Number [default: 4096]')
    parser.add_argument('--step_size', type=int, default=10, help='Decay step for lr decay [default: every 10 epochs]')
    parser.add_argument('--lr_decay', type=float, default=0.7, help='Decay rate for lr decay [default: 0.7]')
    parser.add_argument('--test_scene', type=int, default=1, help='Which scene to use for test')
...
def main(args):
    ...
    TRAIN_DATASET = S3DISDataset(split='train', data_root=root, num_point=NUM_POINT, test_scene=args.test_scene, block_size=1000.0, sample_rate=1.0, transform=None)
    print("start loading test data ...")
    TEST_DATASET = S3DISDataset(split='test', data_root=root, num_point=NUM_POINT, test_scene=args.test_scene, block_size=1000.0, sample_rate=1.0, transform=None)
