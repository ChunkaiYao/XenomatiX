...
def collect_point_label(anno_path, out_filename, file_format='txt'):
    """ Convert original dataset files to data_label file (each line is XYZIL).
        We aggregated all the points from each instance in the room.

    Args:
        anno_path: path to annotations. e.g. Scene_1/pedestrian_1/Annotations/
        out_filename: path to save collected points and labels (each line is XYZIL)
